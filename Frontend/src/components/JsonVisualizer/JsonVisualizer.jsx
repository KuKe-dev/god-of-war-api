...
return (
    <section className="json-visualizer">
            ...
            >
                ...
                />
                <button aria-label='Copy' className='json-visualizer-form-copy' onClick={handleCopy}>
                ...
                <button aria-label="Submit" id='json-visualizer-form-button' className='json-visualizer-form-button' type="submit">Submit</button>
            </form>
